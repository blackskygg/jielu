...
TTF_Init()
font1 = TTF_OpenFont("xingshu.ttf", 100)
...
img = TTF_RenderUTF8_Solid(font1, "呵呵呵呵", SDL_Color(0, 0, 0))
rect = SDL_Rect(0, disp_rect.h/2 - img.contents.h/2, img.contents.w, img.contents.h)
rect2 = rect.__copy__()
